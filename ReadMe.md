...
- Ultralight 1.4 SDK (included in repo) (see [Ultralight pricing/licensing](https://ultralig.ht/pricing/))  
...
3. Build the solution (post-build events automatically copy third-party DLLs).
4. Run the project.
